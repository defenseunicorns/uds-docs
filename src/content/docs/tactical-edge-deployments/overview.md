...
- Applications can run without or without connectivity - a fully air gapped solution
...
<table>
  <tr>
    <td width="40%">
      <img src="../../assets/flight-line-v2.png" alt="Fleet and Asset Management" style="max-width: 100%; border-radius: 8px;">
    </td>
    <td width="60%">
      <ul>
