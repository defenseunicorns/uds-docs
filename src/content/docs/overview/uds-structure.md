...
| **Security and Compliance**        | **[NeuVector](https://open-docs.neuvector.com/):** Offers container-native security, protecting applications against threats and vulnerabilities. *(Note: NeuVector will be removed from UDS Core on November 10, 2025)*<br><br> **[Falco](https://falco.org/):** Provides real-time threat detection and security monitoring for cloud-native environments.<br><br> **[Pepr](https://pepr.dev/):** UDS policy engine and operator for enhanced security and compliance.|
