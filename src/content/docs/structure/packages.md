...
2. It contains the [UDS Package Kubernetes custom resource](https://github.com/defenseunicorns/uds-core/blob/main/docs/reference/configuration/custom-resources/packages-v1alpha1-cr.md).
